// Design tokens for the ERP system
export const tokens = {
  colors: {
...
export type FontWeightScale = keyof typeof tokens.fontWeight;
export type BoxShadowScale = keyof typeof tokens.boxShadow;
export type ZIndexScale = keyof typeof tokens.zIndex;
